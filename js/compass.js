(() => {
  ...
  const chrome = [...document.querySelectorAll('.stage-top, .watermark, .compass-caption, .stage-bottom, .chapter-nav')];
  ...
  function render(time = performance.now()) {
    ...
    const names = document.documentElement.lang === 'en'
      ? ['Understand', 'Plan', 'Review', 'Verify'] : ['理解', '规划', '审阅', '验证'];
  ...
  const english = {
    ...
    title0: 'Give ideas<br /><span>a direction.</span>', body0: 'Great work starts with understanding.<br />An agent that knows your project.<br />A better place to begin.',
    detailTitle0: 'Beyond the conversation.', detailBody0: 'Code, files, and team conventions.<br />Context behind every action.',
    title1: 'Big ideas.<br /><span>Clear steps.</span>', body1: 'Turn an ambitious request into a plan.<br />Tools, tasks, and progress.<br />One connected workspace.',
    detailTitle1: 'See the way forward.', detailBody1: 'Models, MCP, and Skills.<br />Working together, with a plan.', plan1: 'Understand the request', plan2: 'Build the plan', plan3: 'Act and inspect',
    title2: 'Move freely.<br /><span>Keep control.</span>', body2: 'See the intent. Inspect the diff. Decide.<br />Your agent keeps moving.<br />You keep the important choices.',
    detailTitle2: 'Power, with boundaries.', detailBody2: 'Read, propose, and write deliberately.<br />Keep approvals and changes in view.', approval: 'READY FOR YOUR REVIEW',
    title3: 'Real work.<br /><span>Real evidence.</span>', body3: 'From terminal output to verification.<br />Keep a complete record of the work.<br />Pick up where you left off.',
    detailTitle3: 'More than “done”.', detailBody3: 'Checks, diagnostics, output, and warnings.<br />Saved alongside the task.', check1: 'Code checks', check2: 'Terminal output', check3: 'Task record',
